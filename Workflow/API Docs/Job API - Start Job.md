...
Kick starts an existing job by ID. Calls to this operation must include a token acquired from the authentication endpoint. See the \[Login API\]\[1\] for information on acquiring this token.
...
### Example
    ...
    GET http://64.15.188.230/jobs/ALIAS/d268c7e5-3dd9-4c7c-a043-63d0599e7cb3/start
...
| :------------ | :------ | :----------------------------------- | :---- |
| hosts | array | TBD | No |
| sshPrivateKey | array | TBD | No |

## Response

The response will have the latest information of the job.
